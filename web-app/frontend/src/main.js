...
async function sendChatMessage(prompt, zoneContext = null) {
  ...
  try {
    ...
    state.chatMessages[aiMsgIndex].text = `[ICAR संदर्भ]: आपके प्रश्न के संबंध में परामर्श लोड हुआ।\n• मौसम और फसल अनुसार संतुलित सिंचाई करें।\n(बैकएंड Ollama LLM से संपर्क किया जा रहा है)`;
    renderTabContent();
  }
}
